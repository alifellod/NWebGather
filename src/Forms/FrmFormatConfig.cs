...
namespace NWebGather.Forms
{
    ...
    {
        //private const string configFile = "HtmlFormatConfig.xml";

        private XmlSerializer xmlSerializer = new XmlSerializer(typeof(Config));
        ...
        public static Config GetConfig()
        {
            if (File.Exists(SysConfig.HtmlFormatConfigPath))
            {
                ...
                config.WrapTag = NWebGather.Helper.StringFormat.EscapeCharacterDecode(config.WrapTag);
                ...
                config.WhiteTag = NWebGather.Helper.StringFormat.EscapeCharacterDecode(config.WhiteTag);
                ...
                config.IndentTag = NWebGather.Helper.StringFormat.EscapeCharacterDecode(config.IndentTag);

                config.WrapTagTo = NWebGather.Helper.StringFormat.EscapeCharacterDecode(config.WrapTagTo);
                config.WhiteTagTo = NWebGather.Helper.StringFormat.EscapeCharacterDecode(config.WhiteTagTo);
                config.IndentTagTo = NWebGather.Helper.StringFormat.EscapeCharacterDecode(config.IndentTagTo);
                config.OutputTitleFormat = NWebGather.Helper.StringFormat.EscapeCharacterDecode(config.OutputTitleFormat);
                return config;
            }
            return null;
        }
